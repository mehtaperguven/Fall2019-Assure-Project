...
public class SpartanTests {
    ...
    public void addSpartan(){
        ...
        String body = "{ \"gender\": \"Male\", \"name\": \"SDET\", \"phone\": 9999999999 }";
        ...
        given().contentType(ContentType.JSON).auth().basic("admin","admin").body(jsonFile).
                baseUri(BASE_URL).
    ...
    public void deleteSpartanTest(){
        ...
        given().auth().basic("admin","admin").
                baseUri(BASE_URL).when().delete("/api/spartans/{id}",764).
